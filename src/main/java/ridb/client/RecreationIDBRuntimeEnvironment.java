...
public class RecreationIDBRuntimeEnvironment {
    ...
    public enum HTTPStatusCode {
        ...
        static public HTTPStatusCode getStatus(int code){
            ...
            switch (code){
                case 200 -> status = HTTPStatusCode.OK;
                case 400 -> status = HTTPStatusCode.Unauthorized;
            }
            return status;
        }
    }
    ...
    public enum RecreationIDBRequestType{
        ...
        static public String getURLSchema(RecreationIDBRequestType requestType) throws RecreationIDBException {
            String urlSchema;
            switch (requestType) {
                case RecAreas:
                    urlSchema = "/recareas?";
                ...
                case Activities:
                    ...
                    break;
                default:
                    throw new RecreationIDBException("Request type does not exist: " + requestType +".");
            }
            return urlSchema;
        }
    }
    ...
    private String recreationIDBResponseHandler(HttpResponse<String> response) throws RecreationIDBException {
        ...
        if (status == HTTPStatusCode.OK) {
            ...
            if (body == null) {
                ...
                throw new RecreationIDBException("No content received from the Recreation Information Data Base.");
            }
            ...
            if (Objects.requireNonNull(status) == HTTPStatusCode.Unauthorized) {
                ...
                throw new RecreationIDBException("Request failed with code: " + statusCode);
            }
            ...
            if (body == null) {
                ...
                try {
                    ...
                    throw new RecreationIDBException("Cannot read the output from the Recreation Information Data Base response.", e);
                }
            }
            logger.severe("Bad request: " + message);
            throw new RecreationIDBException("Bad Request: " + message);
        }
    }

    public String recreationIDBSendRequest(String input, RecreationIDBRequestType requestType, String apiKey) throws RecreationIDBException{
